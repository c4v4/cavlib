...
requires(std::is_fundamental_v<container_value_type_t<C>> ||
         !std::is_trivially_copyable_v<container_value_type_t<C>>)
void cmp_swap(C& c, Key&& key, size_t i1, size_t i2) {
    auto k1  = key(c[i1]);
    auto k2  = key(c[i2]);
